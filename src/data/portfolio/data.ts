...
export const portfolioContent: Record<Locale, PortfolioTranslation> = {
  'pt-BR': {
    ...
    profile: {
      ...
      location: 'São Paulo, Brasil · Remoto global',
      ...
      socials: [
        ...
        {
          label: 'Twitter/X',
          url: 'https://x.com/ryanalencar',
          ariaLabel: 'Abrir Twitter de Ryan Alencar',
          icon: 'twitter',
        },
        {
          label: 'Email',
          url: 'mailto:contato@ryanalencar.dev',
    ...
    profile: {
      ...
      socials: [
        ...
        },
        {
          label: 'Twitter/X',
          url: 'https://x.com/ryanalencar',
          ariaLabel: 'Open Ryan Alencar Twitter profile',
          icon: 'twitter',
        },
        {
          label: 'Email',
    ...
    profile: {
      ...
      socials: [
        ...
        },
        {
          label: 'Twitter/X',
          url: 'https://x.com/ryanalencar',
          ariaLabel: 'Abrir perfil de Twitter de Ryan Alencar',
          icon: 'twitter',
        },
        {
          label: 'Email',
